...
void uiPresent::touchingUp(ofTouchEventArgs &touch) {
    ...
    if (fontBox->inside(touch.x, touch.y)) {
        ...
        *tableSelected = false;
        *okSaveSelected = false;
        printf(" Font guiPresent task called \n");
    }
    ...
    if (pencilBox->inside(touch.x, touch.y)) {
        ...
        *tableSelected = false;
        *okSaveSelected = false;
        printf(" Pencil guiPresent task called \n");
    }

    if (tableBox->inside(touch.x, touch.y)) {
        //use image tool
        printf(" Table guiPresent task called \n");
        *fontSelected = false;
        *pencilSelected = false;
        *tableSelected = true;
        *okSaveSelected = false;
    ...
    if (okSaveBox->inside(touch.x, touch.y)) {
        //use image tool
        printf(" Save guiPresent task called \n");
        *fontSelected = false;
        *pencilSelected = false;
        *tableSelected = false;
        *okSaveSelected = true;
